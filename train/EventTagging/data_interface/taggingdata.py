...
class EventTaggingData(datasets.GeneratorBasedBuilder):
        ...
        with open(filepath[0], "r", encoding="utf-8") as f:
            ...
            for idx, line in enumerate(lines):
                ...
                for sent in sents:
                    ...
                    all_events_string = "\3".join(all_events)

                    event_num += len(all_events_string.split("\3"))
                    event_list.append(all_events_string)

                    cur_sent_string = "\2".join([cur_text, all_events_string])
                    all_sents.append(cur_sent_string)
                src = "\1".join(all_sents)
                tgt = json_dict["label"]
